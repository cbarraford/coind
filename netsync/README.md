...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/coinsuite/coind/netsync)
...
```bash
$ go get -u github.com/coinsuite/coind/netsync
```
