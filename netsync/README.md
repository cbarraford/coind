...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/coinsuited/coind/netsync)
...
```bash
$ go get -u github.com/coinsuited/coind/netsync
```
