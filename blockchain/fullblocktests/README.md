...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/coinsuite/coind/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/coinsuite/coind/blockchain/fullblocktests
```
