...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/cbarraford/coind/connmgr)
...
```bash
$ go get -u github.com/cbarraford/coind/connmgr
```
