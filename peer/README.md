...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/coinsuite/coind/peer)
...
```bash
$ go get -u github.com/coinsuite/coind/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/coinsuite/coind/peer#example-package--NewOutboundPeer)  
