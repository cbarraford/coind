...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/cbarraford/btcd/peer)
...
```bash
$ go get -u github.com/cbarraford/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/cbarraford/btcd/peer#example-package--NewOutboundPeer)  
