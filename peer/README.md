...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/coinsuited/coind/peer)
...
```bash
$ go get -u github.com/coinsuited/coind/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/coinsuited/coind/peer#example-package--NewOutboundPeer)  
