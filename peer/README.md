...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/cbarraford/coind/peer)
...
```bash
$ go get -u github.com/cbarraford/coind/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/cbarraford/coind/peer#example-package--NewOutboundPeer)  
